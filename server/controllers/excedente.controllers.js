exports.obtenerExcedente = (req, res) => {
    ...
    pool.query('SELECT nombres, nro_cedula, cl_fechnac, anio, nro_socio, por_aporte, por_intereses, por_tarjeta, total_excedente, descuento_credito, desc3, desc4, desc5, retencion_irp, total_deuda, total_a_cobrar FROM excedentesweb WHERE nro_cedula = $1 AND cl_fechnac = $2 and anio= 2021', [inputData1, inputData2], (error, results) => {
        if (error) {
